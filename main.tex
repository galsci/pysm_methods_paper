...
\begin{figure*}
    ...
    \caption{Scatter plots of the mean of the first two $BB$ band powers, $\overline{\mathcal{D}_{\ell\in[40,110]}^{BB}}$,  and the mean of the last four $BB$ band powers, $\overline{\mathcal{D}_{\ell\in[110,370]}^{BB}}$, as shown in Figure~\ref{fig:smallfield_power}. The top panel compares $\overline{\mathcal{D}_{\ell\in[40,110]}^{BB}}$ of NPIPE against \texttt{d1}, \texttt{d9}, \texttt{d12} and NPIPE itself. The middle panel shows the same comparison but for $\overline{\mathcal{D}_{\ell\in[110,370]}^{BB}}$. The bottom panel shows the scatter plots of $\overline{\mathcal{D}_{\ell\in[40,100]}^{BB}}$ versus $\overline{\mathcal{D}_{\ell\in[110,370]}^{BB}}$ for each data set. 

Here are scatter plots of the mean of the first two $BB$ band powers, $\overline{\mathcal{D}{\ell\in[40,110]}^{BB}}$, and the mean of the last four $BB$ band powers, $\overline{\mathcal{D}{\ell\in[110,370]}^{BB}}$, as shown in Figure~\ref{fig
}.

The top panel compares $\overline{\mathcal{D}_{\ell\in[40,110]}^{BB}}$ for NPIPE against both PySM models and NPIPE itself.
The middle panel shows the same comparison but for $\overline{\mathcal{D}_{\ell\in[110,370]}^{BB}}$.
The bottom panel plots $\overline{\mathcal{D}{\ell\in[40,110]}^{BB}}$ against $\overline{\mathcal{D}{\ell\in[110,370]}^{BB}}$ for each data set.
...
Each data point represents the results from a circular sky patches with $|b| > 30^\circ$. Dashed reference lines indicating $\mathcal{D}_\ell^{BB} \propto \ell^{-0.42}$ are added to the plots. This power law in fact comes from the analysis of several larger sky regions ($f_\text{sky} = 0.3 \; \text{to} \; 0.8$) by \cite{planck2014-XXX}, but the small-field NPIPE data points, which spread out when the dust amplitude is small presumably due to map noise, are consistent with it as well. Another important feature is that the trends of the \texttt{d1}, \texttt{d9} and \texttt{d12} data points are slightly lower than that of the NPIPE in these log-log plots, implying that the model spectra are steeper.}
