...
%Our approach differs from that of \citet{Thorne:2017} in that their modulation map was constructed on $N_{\rm side} = 2$ superpixels. The procedure presented in this work claim to improve the quality of the  maps employing more local Galactic  features by increasing the resolution of the modulation templates.
