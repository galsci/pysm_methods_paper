...
\begin{figure}[ht!]
    ...
    \caption{Relative extragalactic contamination (arbitrary units) in the new dust templates \texttt{d10} and \texttt{d12}, compared to the \texttt{d1} model. Contamination is quantified as the excess 857 GHz emission within $11\arcmin$ of galaxies from the GLADE+ catalog, normalized to the maximum excess across all models, and plotted as a function of redshift $z$. The new dust templates contain less extragalactic contamination than older dust models because they are based on GNILC-processed Planck data. The improvement is most significant for \texttt{d10}.}
