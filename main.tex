...
\begin{figure}[ht!]
    \centering
    \includegraphics[width=0.5\textwidth]{figures/gal_plane_non_smooth_wo_zero_lvl.png}\hfill
    \includegraphics[width=0.5\textwidth]{figures/BK_smooth_30'_wo_zero_lvl.png}
\caption{Dust intensity at 353GHz at [l = 180, b = -10] and [l = 318, b = -61] with an angular resolution of $4.94\arcmin$: (a) PR3 (b) d1 (c) d9 (d) d12.}    
...
\begin{figure}[ht!]
    ...
    \caption{Polarized dust intensity at 353GHz centered at [l = 180, b = -10] and [l = 318, b = -31], smoothed to $30\arcmin$: (a) PR3 (b) d1 (c) d9 (d) d12.}
...
As expected, in intensity, we see that d12 is more similar to the actual data in Figure~\ref{fig:353_int_gal_plane} than d9 that has random small-scale generation up to larger scales. We can visually appreciate the impact of different prescriptions for adding small-scales in intensity, with more structures in model d9. %comment about d1 ressembling data more than d9, especially for patch centered in Bicep-Keck region?
