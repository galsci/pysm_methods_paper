...
We remark here that,  the templates  of $\beta_d$ and $T_d$ employed for the new models  show a high level of  degeneracy. This is mainly because the parameters are intrinsically degenerate when few frequency channels are used to perform the estimate.   making the maps at small angular scales ($<21.8^\prime$) are contaminated by artifacts due to noise and calibration errors. 
