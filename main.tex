...
Note that the color scale is different for the right panel of Fig.~\ref{fig:353_int}; it is mainly due to the uncertainty in the CIB monopole. In the case of model {\tt d1} (b), it is due to the difference in the CIB monopole between PR3 and PR2 products, as model {\tt d1} is based on PR2 data. 
