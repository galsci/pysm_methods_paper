...
\tablewidth{0pt}
\tablehead{
\colhead{Comp}  & \colhead{Tag} & \colhead{Templates at large scales} & \colhead{Templates at small scales} & \colhead{Frequency scaling} & \colhead{Frequency scaling at small scales} & \colhead{Stochasticity} & \colhead{Modelling properties} & \colhead{Max Nside}} 
\startdata
