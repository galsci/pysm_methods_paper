...
\begin{figure*}
    ...
    \caption{The PySM \texttt{d9} maps, reobserved maps and purified masked maps at delta 353 GHz. Each panels of these PySM maps are reprocessed by the BK18 BICEP3 beam profile, observation matrix and purification matrix respectively.}
