...
We find that all three models respect the upper limit set by \citet{planck2016-l11A}, with d12 coming closest to saturating it (quantify), then d10, then d1. The models thus span a range of viable levels of decorrelation. Because the spectral parameters ($T_d$ and $\beta_d$) of the d9 model do not vary across the sky, that model has no decorrelation by construction (i.e., $R_\ell = 1$).
