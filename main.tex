...
When the same process is applied to other PySM models at frequencies of interest, we acquire a set of filtered foreground maps which represent the realistic outcomes from a B-mode measurement of the sky patch. ... figure ... 
