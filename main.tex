...
\caption{Summary of the PySM 3.4 models - Dust. All models have a maximum $N_\text{side} = 8192$, excep that \texttt{d12} has 2048.}
\tablewidth{0pt}
\tablehead{
...
\hline
\texttt{d12} &  GNILC PR2 (I) + PR3 (QU) 353 GHz & Modulated + gaussian & Random realization for each layer & Random realization for each layer & Deterministic & 6 layers each modelled as a different modified black body & 2048 \\
%\bottomrule
%\end{tabular}
%\end{center}
\enddata
