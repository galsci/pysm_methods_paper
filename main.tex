...
Note that the color scale is different for the right panel of Fig.~\ref{fig:353_int}; it is mainly due to the uncertainty in the CIB monopole.\footnote{For the generation of model {\tt d12}, a monopole of 0.09~MJy/sr is subtracted from the DR2 GNILC intensity map} 
