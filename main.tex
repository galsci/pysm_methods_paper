...
\begin{deluxetable*}{m{0.5cm} m{2.5cm} m{2.2cm} m{2.4cm} m{2.2cm} m{2.6cm} m{2.8cm}} \label{table:summarydust}
...
\hline
\\
\texttt{d10} & \centering Same as above & Same as above & \centering $\beta_d, \, T_d$ from GNILC PR2 & \centering Modulated & \centering Deterministic & \centering Same as above \tabularnewline
\hline
...
\begin{deluxetable*}{m{0.5cm} m{2.5cm} m{2.2cm} m{2.4cm} m{2.2cm} m{2.6cm} m{2.8cm}} \label{table:summarysynch}
...
\begin{deluxetable*}{m{0.5cm} m{4.2cm} m{4.4cm} m{2.6cm} m{3cm}} \label{table:summaryco}
...
\startdata
\texttt{co1} & \centering PR1 MILCA smoothed to $1^{\circ}$ & \centering --- & \centering Deterministic & Single line emissions at 115, 230, 346~GHz \\
\hline
\texttt{co2} & \centering Same as above & \centering ---  & \centering Deterministic & Same as above + $0.1\%$ polarized \\
\hline
\\
\texttt{co3} & \centering Same as above & \centering Simulated high galactic clouds & \centering Deterministic & \centering Same as above \tabularnewline
\enddata
\end{deluxetable*}
