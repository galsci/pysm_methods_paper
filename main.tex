...
We remark here that the templates  of $\beta_d$ and $T_d$ employed for the new models  used in our new models exhibit significant degeneracy. This degeneracy arises from two primary factors: intrinsic parameter correlations, as highlighted in recent literature  \citep{Demyk:2017}, and limitations in the fitting procedure.  Specifically, using a limited number of \emph{Planck} frequency channels (217, 353, 545, 857 GHz)introduces further parameter degeneracies.  Crucially, the inclusion of synthesized small angular scales  ($<21.8^\prime$) addresses this issue. While this injection mitigates noise and calibration errors, its most significant effect is the complete breaking of the $\beta_d - T_d$degeneracy.
