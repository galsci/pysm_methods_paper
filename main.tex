...
%%%
Lastly, we compare synchrotron models with the BK results. We only concentrate on the old synchrotron \texttt{s1} model and the new model \texttt{s5}


in the lower panel of Figure~\ref{fig:BKfield_power}
