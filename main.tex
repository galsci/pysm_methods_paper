...
In intensity, as expected, we see that d12 is more similar to the actual data in Figure~\ref{fig:353_int_gal_plane} than d9 that has random small-scale generation. We can visually appreciate the addition of small-scales between (b) and (c) where we notice the finer structures 
