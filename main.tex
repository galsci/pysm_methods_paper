...
\begin{deluxetable}{lccccc}
    ...
    \enddata
    \tablecomments{The deviation ratio of the reobserved \texttt{PySM} dust $BB$ spectrum to the BK18 maximum likelihood dust model at each frequency. These ratios are derived by fitting the nine bandpowers of the BK18 model to those of the \texttt{PySM}.}
