...
\startdata
\texttt{d9} &  GNILC PR2 ($I$) + GNILC PR3 ($Q$/$U$) 353 GHz & Modulated + polarization tensor & Uniform spectral parameters & \centering ---  & \centering Deterministic & Modified blackbody \\
\hline
\\
\texttt{d10} & Same as above & Same as above &  $\beta_d, \, T_d$ from GNILC & \centering Modulated & \centering Deterministic & \centering Same as above \tabularnewline
\hline
\texttt{d11} & Same as above & Same as above & Same as above & \centering Same as above & Stochastic $I$/$Q$/$U$ \& spectral parameters & \centering Same as above \tabularnewline
\hline
...
\colhead{Tag} & \colhead{Templates} & \colhead{Templates} & \colhead{Frequency scaling} & \colhead{Frequency scaling} & \colhead{Stochasticity} & \colhead{Model} \\ & \colhead{at large scales} & \colhead{at small scales} & & \colhead{at small scales}}
\startdata
\texttt{s4} & Haslam ($I$) 408 MHz + WMAP ($Q$/$U$) 23 GHz & Modulated + polarization tensor & Uniform spectral index & \centering --- & \centering Deterministic & \centering Power law \tabularnewline
\hline
\\
\texttt{s5} & Same as above & Same as above & $\beta_s$ from Haslam, S-PASS, WMAP & \centering Modulated & \centering Deterministic & \centering Power law \tabularnewline
\hline
\texttt{s6} & Same as above & Same as above & Same as above & \centering Same as above & Stochastic $I$/$Q$/$U$ \& spectral index & \centering Power law \tabularnewline
\hline
\\
\texttt{s7} & Same as above & Same as above & Same +  $c_s$ from ARCADE & \centering Same + $c_s$ fluctuations & \centering Deterministic & \centering Curved power law \tabularnewline
\enddata 
\end{deluxetable*}
