...
A key limitation of the current synchrotron templates is that, despite the point source masking, we still find excess power from Galactic point sources at low Galactic latitudes near the Galactic center. We find that our models are unaffected by this issue at $\ell \lesssim 3000$ and outside the Galactic plane. Addressing small scale structures in bright regions will be deferred to a future release.
