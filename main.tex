...
\tablewidth{0pt}
\tablehead{
\colhead{Tag} & \colhead{Spectrum Model} & \colhead{Templates} & \colhead{Templates} & \colhead{Frequency scaling} & \colhead{Frequency scaling} & \colhead{Stochasticity} \\ & & \colhead{at large scales} & \colhead{at small scales} & \colhead{at large scales} & \colhead{at small scales}}
\startdata
...
\hline
\\
\texttt{s5} & \centering Power law & \centering \textquotedbl & \textquotedbl & $\beta_s$ from Haslam, S-PASS, WMAP & \centering Modulated & \centering --- \tabularnewline
\hline
\\
\texttt{s6} & \centering Power law & \centering \textquotedbl & \textquotedbl & \textquotedbl & \centering \textquotedbl & $I$, $Q$, $U$ \& $\beta_s$ \tabularnewline
\hline
\\
