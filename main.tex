...
\tablewidth{0pt}
\tablehead{
\colhead{Tag} & \colhead{Spectrum Model} & \colhead{Templates} & \colhead{Templates} & \colhead{Frequency scaling} & \colhead{Frequency scaling} & \colhead{Stochasticity} \\ & \colhead{Scale} & \colhead{Large scale} & \colhead{Small scale} & \colhead{Large scale} & \colhead{Small scale}}
\startdata
...
\tablewidth{0pt}
\tablehead{
\colhead{Tag} & \colhead{Spectrum Model} & \colhead{Templates} & \colhead{Templates} & \colhead{Stochasticity} \\ & \colhead{Scale} & \colhead{Large scale} & \colhead{Small scale}}
\startdata
