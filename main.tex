...
\begin{figure}
    ...
    \caption{Comparison of the \texttt{PySM} and NPIPE $BB$ power spectra for the BK patch against the BK18 foreground constraints. The top panel shows the dust results at 353~GHz, while the bottom panel presents the synchrotron results at 23~GHz. These nine bandpowers correspond to the BK science bins used for delivering constraints. The shaded regions and arrow symbols indicate uncertainties in foreground amplitudes: $\pm 0.75 \; \mu\rm{K^2_{CMB}}$ for dust and 95\% upper limits for synchrotron, based on BK18 MCMC constraints. Bandpowers with 95\% upper limits exceeding 5~$\mu\rm{K^2_{CMB}}$ are not displayed in this figure.}
