...
\begin{deluxetable}{lccccc}
    ...
    \enddata
    \tablecomments{The deviation ratio of the reobserved \texttt{PySM} dust $BB$ spectrum to the BK18 maximum likelihood dust model at each frequency. These ratios are derived by fitting the BK18 model to the \texttt{PySM} bandpower at their science bins.}
