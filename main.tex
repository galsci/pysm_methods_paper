...
As expected, in intensity, we see that d12 is more similar to the actual data in Figure~\ref{fig:353_int_gal_plane} than d9 that has random small-scale generation. We can visually appreciate the addition of small-scales between (b) and (c) where we notice the finer structures in model d9. %comment about d1 ressembling data more than d9, especially for patch centered in Bicep-Keck region?
